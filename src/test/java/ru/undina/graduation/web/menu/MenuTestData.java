...
public class MenuTestData {
    ...
    public static final Menu menu4 = new Menu(MENU1_ID + 3, restaurant1, LocalDate.now().minusDays(1), dishMenu1);
    public static final Menu menu5 = new Menu(MENU1_ID + 4, restaurant3, LocalDate.now().minusDays(1), dishMenu2);
    public static final Menu menu6 = new Menu(MENU1_ID + 5, restaurant3, LocalDate.now().minusDays(2), dishMenu3);
